...
const seed = db.transaction(() => {
  db.prepare(`
    ...
    ON CONFLICT(slug) DO UPDATE SET
      ...
      camera_position_x = COALESCE(places.camera_position_x, excluded.camera_position_x),
      camera_position_y = COALESCE(places.camera_position_y, excluded.camera_position_y),
      camera_position_z = COALESCE(places.camera_position_z, excluded.camera_position_z),
      camera_target_x = COALESCE(places.camera_target_x, excluded.camera_target_x),
      camera_target_y = COALESCE(places.camera_target_y, excluded.camera_target_y),
      camera_target_z = COALESCE(places.camera_target_z, excluded.camera_target_z),
